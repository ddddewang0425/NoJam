...
export default function TimetableEntryForm({ onClose }) {
  ...
  const handleSubmit = async () => {
    ...
    if (linkTask) {
      // Create a 7-day repeating task for each day
  ...
  return (
    <div className="flex flex-col gap-4 p-4 w-full max-w-sm">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-zinc-900">시간표 일정 추가</h3>
      ...
      {/* Day selection */}
      <div>
        <label className="text-[11px] font-semibold text-gray-400 tracking-wide select-none">요일 (복수 선택 가능)</label>
